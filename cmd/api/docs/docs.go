...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/translations/articles/{id}/translate": {
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.TranslationRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/translations/cache/invalidate": {
            "post": {
        ...
        "/api/translations/comments/bulk-translate": {
            "post": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.BulkTranslationRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.LocalizedComment"
                        }
                    }
                }
            }
        },
        "/api/translations/comments/{id}/translate": {
            "post": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.ErrorMessageTranslation"
                        }
                    }
                }
            }
        },
        "/api/translations/forms/{form}/{field}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.FormTranslation"
                        }
                    }
                }
            }
        ...
        "/api/translations/seo/{type}/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Entity type (page, article)",
                        "name": "type",
                        "in": "path",
                        "required": true
                    },
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.LocalizedSEOSettings"
                        }
                    }
                }
            }
        ...
        "/api/translations/ui/{language}/{key}": {
            "get": {
    ...
    "definitions": {
        ...
        "handlers.BulkTranslationRequest": {
            "type": "object",
            "required": [
                "comment_ids",
                "target_languages"
        ...
        "models.ArticleContentBlockTranslation": {
            ...
            "properties": {
                ...
                "translated_meta": {
                    "description": "For alt_text, caption, titles etc.",
                    "type": "object"
                },
                "updated_at": {
                    "type": "string"
        ...
        "models.ErrorMessageTranslation": {
            ...
            "properties": {
                "category": {
                    "description": "validation, system, auth, etc.",
                    "type": "string"
                },
                "created_at": {
                    "type": "string"
        ...
        "models.LocalizedComment": {
            ...
            "properties": {
                ...
                "is_original": {
                    "description": "Whether this is the original comment",
                    "type": "boolean"
                },
                "language": {
                    "type": "string"
